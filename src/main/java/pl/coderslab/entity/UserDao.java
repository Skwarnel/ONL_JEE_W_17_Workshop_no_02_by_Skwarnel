...
public class UserDao {
    ...
    public void update(User user) {
        ...
        try (Connection conn = DbUtil.getConnection()) {
            ...
            preparedStatement.setString(2, "New email");
            preparedStatement.setString(3, hashPassword("New Password"));
    ...
    public User[] findAll() {
        ...
        for (int i = 0; i < usersArr.length; i++) {
            System.out.println(usersArr[i].getUserName());
        }

        System.out.println("Number of objects: " + usersArr.length);
        return usersArr;
    }
